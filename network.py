...
class Window:
    ...
    def __init__(self, window, colour='White', width=1440, height=720):
        ...
        self._connector = {"connector": None, "item": None, "item2": None, "x": 0, "y": 0, "x2": 0, "y2": 0,
                           "tag": "False"}
    ...
    def CreateComputer(self, x_start, y_start, color, tag):
        ...
        if temp <= temp2:
            ...
            self.MainCanvas.create_rectangle(x_start - 40, y_start - 25, x_start + 40, y_start + 25, outline=color,
                                             fill=color, tags=(
                "PCdrag", self._state_change["tag"], "ColourSwitch", self._connector["tag"], tag))
